...
#        polarity = self.cal_polarity(data[0])
        ...
        nltk = NLTKAPI.get_score(data[0])
  #      result = textblob_API.get_score(data[0])
        result = sentiment.main(data[0])

        self.write_row(data[1]+","+str(result)+","+str(nltk[3])+'\n')
